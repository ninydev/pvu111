...
/**
 * Here we demonstrate how to inject new SAS for an ongoing bigFileUpload_upload.
 * SAS might get expired before a large bigFileUpload_upload finishes, for this scenario, we want to request a new
 * SAS token during the bigFileUpload_upload instead of starting a new bigFileUpload_upload.
 *
 ...
 * - Update url in `bigFileUpload_upload()` method
 *
 * This sample creates a global function called `bigFileUpload_upload` that will bigFileUpload_upload
 * data from a file bigFileUpload_upload form. For example, the following HTML will create
 * such a form.
 *
 * <form><input type="file" id="file" /></form>
 * <button id="bigFileUpload_upload" onclick="bigFileUpload_upload()">Upload</button>
 *
...
async function bigFileUpload_upload() {
